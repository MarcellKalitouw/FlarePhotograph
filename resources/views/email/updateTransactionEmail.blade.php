                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                <p>
                                                    Terimakasih sudah mengikuti alur transaksi kami dengan baik, dan saat ini
                                                    status transaksi anda
                                                    sudah ada pada tahap <strong> {{ $getTransaksi->status_transaksi }} </strong>
                                                </p>
                                                <br>
                                                <strong>Flare Photography Team.</strong>
                                            </div>
                                     ...
                                     <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                <a href="https://www.htmlemailtemplates.net"
                                                    style="color:#2F67F6">flarephotograph.com</a>
                                            </div>
