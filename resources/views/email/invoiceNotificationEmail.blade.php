                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                <tr style="border-bottom:1px solid #ecedee;text-align:left;">
                                                    <th colspan="4">Produk yang diorder</th>
                                                </tr>
                                                <tr style="border-bottom:1px solid #ecedee;text-align:left;">
                                                    <th style="padding: 0 15px 10px 0;">Item</th>
                                                    <th style="padding: 0 15px;">Varian</th>
                                                    <th colspan="2" style="padding: 0 0 0 15px;" align="right">Harga</th>
                                                </tr>
                                                @foreach ($getTransaksi->detail_transaksi as $data)
                                                    <tr>
                                                        <td style="padding: 5px 15px 5px 0;">{{ $data->nama_produk }}</td>
                                                        <td style="padding: 0 15px;">{{ $data->nama_varian ? $data->nama_varian : "-" }}</td>
                                                        <td style="padding: 0 0 0 15px;" align="right">
                                                            <p>Varian  Rp.{{$data->harga_varian ? number_format($data->harga_varian) : "-"}}</p>
                                                            <p>Pokok  Rp.{{number_format($data->harga)}}</p>
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                        ...
                                                        <td colspan="2" style="padding: 0 0 0 15px; font-weight:bold" align="right">{{number_format($data->harga)}}</td>
                                                    </tr>   
                                                @endforeach
                                                <tr>
                                                    <th colspan="3">Produk yang diorder</th>
                                                </tr>
                                                <tr style="border-bottom:1px solid #ecedee;text-align:left;">
                                                    <th style="padding: 0 15px 10px 0;">Hari/Jam</th>
                                                    <th style="padding: 0 15px;">Bentuk Pembayaran</th>
                                                    <th style="padding: 0 15px;">Status Transaksi</th>
                                                    <th style="padding: 0 0 0 15px;" align="right">Total Transaksi</th>
                                                </tr>
                                                <tr>
                                                    {{-- <th scope="row">1</th> --}}
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{ $getTransaksi->bentuk_pembayaran }}
                                                    </td>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Best regards,<br><br> Admin<br>Flare Photograph<br>
                                                <a href="https://www.htmlemailtemplates.net" style="color:#2F67F6">flarephotograph.com</a>
                                            </div>
