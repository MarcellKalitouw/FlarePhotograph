...
<body class="signup-page" >
    <div class="signup-box">
        <div class="logo" >
            <a href="javascript:void(0);">Pendaftaran Pengguna<b> - Flare Photography</b></a>
            ...
            <div class="body">
                <form id="sign_up" method="POST" action="{{ route('register.store') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="number" class="form-control" name="no_hp" placeholder="Nomor WA, Nomor Telepon aktiv..." required >
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    @if ($errors->any())
                        ...
                        @endif  
                    <div class="m-t-25 m-b--10 align-center">
                        <a href="{{ route('login.index') }}">Anda telah memiliki akun?</a>
                    </div>
                </form>
            </div>
        </div>
